Create one horizontal look-direction strip for Codex pet `johnny-silverhand`, atlas row 10.
...
Output exactly 8 complete holographic bust frames in this exact left-to-right order: 180, 202.5, 225, 247.5, 270, 292.5, 315, 337.5. Degrees are clockwise: 000 is up, 090 right, 180 down, and 270 left. Neutral/front is not part of this row.
