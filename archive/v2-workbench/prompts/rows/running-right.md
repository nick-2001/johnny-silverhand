Create one horizontal animation strip for Codex pet `johnny-silverhand`, state `running-right`.
...
Identity: same pet in every frame: Preserve existing realistic Johnny Silverhand holographic bust, long dark hair, sunglasses, beard, black vest and silver cybernetic left arm; retain user-approved cyan holographic lower-bust dissolution.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
